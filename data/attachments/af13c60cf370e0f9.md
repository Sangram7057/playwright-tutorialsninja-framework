...
- Name: regression/cart.regression.spec.ts >> Cart management >> updating quantity keeps the product and re-renders totals
- Location: tests/regression/cart.regression.spec.ts:25:3
