...
- Name: regression/register.negative.regression.spec.ts >> Registration validation >> mismatched password confirmation is rejected
- Location: tests/regression/register.negative.regression.spec.ts:27:3
...
Call log:
  - waiting for locator('#input-firstname')
    ...
    4 × navigated to "https://tutorialsninja.com/demo/index.php?route=account/register"
