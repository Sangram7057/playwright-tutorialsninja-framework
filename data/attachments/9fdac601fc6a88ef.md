...
- Name: regression/navigation.regression.spec.ts >> Navigation >> opening a top-level category lands on its listing page
- Location: tests/regression/navigation.regression.spec.ts:9:3
...
Call log:
  - waiting for locator('#menu').getByRole('link', { name: 'Tablets', exact: true })
    - waiting for navigation to finish...
    2 × navigated to "https://tutorialsninja.com/demo/index.php?route=common/home"
