...
- Name: smoke/login.smoke.spec.ts >> Login >> invalid credentials are rejected with a warning
- Location: tests/smoke/login.smoke.spec.ts:8:3
...
Call log:
  - navigating to "https://tutorialsninja.com/demo/index.php?route=account/login", waiting until "domcontentloaded"
