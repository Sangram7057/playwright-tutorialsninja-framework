...
- Name: regression/register.negative.regression.spec.ts >> Registration validation >> registering with an already-used email is rejected
- Location: tests/regression/register.negative.regression.spec.ts:8:3
...
Call log:
  - navigating to "https://tutorialsninja.com/demo/index.php?route=account/register", waiting until "domcontentloaded"
