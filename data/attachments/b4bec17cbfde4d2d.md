...
- Name: regression/account.regression.spec.ts >> Account session >> a registered user reaches the dashboard and can log out
- Location: tests/regression/account.regression.spec.ts:8:3
