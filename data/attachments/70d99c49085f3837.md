...
- Name: regression/wishlist.regression.spec.ts >> Wishlist >> a product can be added to and removed from the wishlist
- Location: tests/regression/wishlist.regression.spec.ts:13:3
