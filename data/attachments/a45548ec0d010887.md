...
- Name: regression/account.regression.spec.ts >> Account session >> edit-account page is reachable when authenticated
- Location: tests/regression/account.regression.spec.ts:29:3
